...
print(f'3.2 feladat: Épületek száma: {epuletek_szama}')
...
if van_orszag('Olaszország'):
    print('3.5 felada: Van olasz épület az adatok között!')
else:
    print('3.5 felada: Nincs olasz épület az adatok között!')